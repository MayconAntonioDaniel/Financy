            ...
            return (
              <TableRow key={transaction.id} className="border-gray-200">
                <TableCell className="flex items-center gap-2 p-4">
                  <div
                    className={`w-10 h-10 ${categoryStyles.bgLight} rounded-md flex items-center justify-center mr-2`}
                  >
                    <IconComponent
                ...
                <TableCell>
                  <div
                    className={`px-4 py-1 rounded-full ${isIncome ? "text-green-base bg-green-light" : "text-red-base bg-red-light"} font-bold w-max`}
                  >
                    {transaction.type}
                  </div>
                </TableCell>
